...
public:
  ...
  bool compareSwapFormats(const VaSwapChain &other) const {
...
private:
  ...
  std::vector<VkDeviceMemory> colorImageMemoryHandles;
  ...
  // This is a map of current frame -> VkFence, for every frame in flight we
